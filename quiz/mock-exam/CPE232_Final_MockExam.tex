...
\begin{enumerate}[label=\textbf{\arabic*.}]
    \item \textbf{Descriptive Analytics} \hfill [Intro]
    \vspace{2.2cm}

    \item \textbf{Diagnostic Analytics} \hfill [Intro]
    \vspace{2.2cm}

    \item \textbf{Predictive Analytics} \hfill [Intro]
    \vspace{2.2cm}

    \item \textbf{Prescriptive Analytics} \hfill [Intro]
    \vspace{2.2cm}
